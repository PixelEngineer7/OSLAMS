...
$database = new DBHandler();
$viewAll = new rental();
$view=$viewAll->getReportRentalTerminatedLandlord($landlordID);
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="w3-container">
    ...
    <button class="btn btn-info" onClick="window.print()">Print</button>&nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportTerminatedRentalLandlord.php';">Export</button>
  </div>
