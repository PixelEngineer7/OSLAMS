<?php
    ...
    //Scope: First Time User Registration / Registration of Landlord Personal Details
    session_start(); 
    ...
    if (isset($_POST["btnSubmit"]))
  {
    ...
    $landlord->addLandlord($_SESSION['username'],$type,$email,$phone,$mobile);
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Welcome | Registration Of Landlord Personal Details </title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
    <div class="w3-container">
      <center><img src="../images/FirstTime.png" class="img-responsive" alt="Add New User Logo" style="width:80px;"></center>
    <br>
          ...
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input pattern="[0-9]{7}" title="Please enter valid local number Eg: 263XXXX" type="tel" class="form-control" id="mobile" name="phone" required></input>
            </div>
