...
if (isset($_POST['btnSubmit']))
  {
    ...
    $modifyLandlord = new landlord();
    $modifyLandlord->updateProfile($_SESSION['userID'],$mobile,$phone);
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Landlord | Landlord Details Dashboard </title>
<meta charset="UTF-8">
     ...
     <form method="post" enctype="multipart/form-data" >
        <div class="panel panel-success">
          <div class="panel-heading">
             <h3 class="text-center"><i class="fa fa-info-circle" aria-hidden="true"></i> Update Landlord Personal Information</h3>
          </div>
        <div class="panel-body">
          <form >
                ...
                <div class="form-group">
                    ...
                    <?php echo "<input type='tel' name='phone' class='form-control' value='".$row['phone']."'>";?> 
                </div>
