...
<?php
 ...
 //Scope: Landlord Dashboard / Property Management Dashboard
session_start();
...
$database=new DBHandler();
$p1=new property();
$PA=$p1->countPM($landlordID);
foreach ($PA as $rowA) 
  $PA=(int)$rowA['totalUnavailable'];

$p2=new property();
$PB=$p2->countPLAavailable($_SESSION['landlordID']);
foreach ($PB as $rowB) 
  $PB=(int)$rowB['totalAvailable'];

$p3=new property();
$PC=$p3->countPLApproval($_SESSION['landlordID']);
foreach ($PC as $rowC) 
  $PC=(int)$rowC['totalApproved'];

$p4=new property();
$PD=$p4->countAllLandlord($_SESSION['landlordID']);
foreach ($PD as $rowD) 
  $PD=(int)$rowD['totalLandlord'];
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Landlord | Property Management Dashbord </title>
<meta charset="UTF-8">
...
<div class="w3-row-padding w3-margin-bottom">
  <div class="w3-quarter">
    <div class="w3-container w3-indigo w3-padding-16 shadow">
      ...
      <h6>Landlord Property Under Maintenance</h6>
    </div>
  </div>
  <div class="w3-quarter">
    <div class="w3-container w3-blue w3-padding-16 shadow">
      ...
      <div class="w3-clear"></div>
      <h4>Landlord Property Available For Rent</h4>
    </div>
  </div>
  <div class="w3-quarter">
    <div class="w3-container w3-teal w3-padding-16 shadow">
      ...
      <div class="w3-clear"></div>
      <h4>Landlord Property required Approval</h4>
    </div>
  </div>
  <div class="w3-quarter">
    <div class="w3-container w3-orange w3-text-white w3-padding-16 shadow">
      ...
      <div class="w3-clear"></div>
      <h4>Total of Landlord Registered Property</h4>
    </div>
  </div>
</div>
...
<div class="w3-container">
  <div class="panel panel-primary shadow">
    <div class="panel-heading"><h4><center>List of All Registered Property By Landlord</center></h4>
    </div>
     ...
     <table class="table table-hover" id="myTable">
          <tr>
           ...
           <th onclick="sortTable(1)" scope="col">Property Type <i class="fa fa-sort"></i> </th>
            ...
            <th scope="col">Property Approval By UDM</th>
        ...
        <?php while ($row = mysqli_fetch_array($result))   { ?>
          <tbody id="myTable">
            <tr>
              ...
              <td>Rs. <?php echo $row['rentalFee']; ?></td>
