...
if(!$conn){
  die('Could not Connect My OSLAMS UDM Database Sql:' .mysql_error());
}
...
$result = mysqli_query($conn,"SELECT * FROM tblbooking WHERE landlordID='$landlordID' ORDER BY bookingID ASC LIMIT $start_from, $limit");
...
<div class="w3-container">
  <div class="panel panel-danger shadow">
    <div class="panel-heading"><h4><center>List Of Bookings Made to Landlord Properties</center></h4>
    </div>
    <div class="table-responsive">
      ...
      <table class="table table-hover" id="myTable">
        <tr>
          ...
          <th onclick="sortTable(1)" scope="col">Booking Status <i class="fa fa-sort"></i> </th>
        ...
        <?php while ($row = mysqli_fetch_array($result))   { ?>
          <tbody id="myTable">
            <tr>
              ...
              <td><?php echo "<a  class='btn btn-success' href='bookingApprovalUpdate.php?action=update&QStrbookingID=".$row['bookingID']."'>Update</a>"; ?></td>
            </tr>
      ...
      for ($i=1; $i<=$total_pages; $i++) {
        $pagLink .= "<li class='page-item'><a class='w3-hover-blue' href='bookingApproval.php?page=".$i."'>".$i."</a></li>"; 
      }
      echo $pagLink . "</ul>";  
      ?>
    </div>
