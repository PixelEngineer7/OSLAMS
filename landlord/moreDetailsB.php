<?php
  ...
  //Scope: Prospect Student Dashboard / List of Porperty On rent
session_start();
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="card text-black shadow" style="width: 38rem;">
        ...
        <div class="card-txt">
          <center>
           <?php echo "<a  class='btn btn-success' href='propertyBookingsB.php?action=update&QStrpropertyID=".$row[0]['propertyID']."'>Book Here</a>"; ?> &nbsp;&nbsp; <?php echo "<a  class='btn btn-danger' href='propertyOnRentsB.php'>Cancel</a>"; ?> </center>
         </div>
       </div>
     </div>
   </div>
