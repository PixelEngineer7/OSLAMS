...
$view=$viewAll->propertyLandlordOnRent($landlordID);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <h3 style="font-size:20px;"><center><u>Property Reports</u></center></h3>
...
<button class="btn btn-info" onClick="window.print()">Print</button>&nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportRegPropertyAvail.php';">Export</button>
</div>
