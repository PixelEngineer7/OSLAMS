...
if (isset($_GET['QStrtenantID'] ,$_GET['QStrpropertyID'] , $_GET['QStrrentalID'] , $_GET['QStrbookingID']  ))
  {
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Landlord | Rental Agreement Dashbord </title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:33px">
     <h4></strong>&nbsp;<b><i class="fa fa-tachometer" aria-hidden="true"></i> | Rental Agreement </b></h4>
  </header>
...
<!-- START of Container to have Form for Tenant -->
  ...
  <div class="panel-footer">Read And Approved By the Tenant
    <div class="form-group">
              <label for=""><u>Digital Signature</u></label><br>
              <q><i> <?php echo $remarks ?> </i></q>
            </div>
  </div>
