<?php
  ...
  session_start();
    ...
    //Data is being return in form of an associative array
              ...
              <div class="card">
                ...
                &nbsp;
                 <?php echo "<img src = 'images/" . $row['pictures'] ."' '>";?>
                  ...
                  <div class="card-txt">
                      <center><?php echo "<a  class='btn btn-success' href='propertyBooking.php?action=update&QStrpropertyID=".$row['propertyID']."'>Book</a>"; ?></center>
                  </div>
                  <div class="card-txt">
