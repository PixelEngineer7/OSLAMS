...
$database=new DBHandler();
$book1=new booking();
$BA=$book1->countConfirmLandlordBooking($_SESSION['landlordID']);
foreach ($BA as $rowA) 
{
...
$book2=new booking();
$BB=$book2->countPendingBooking($_SESSION['landlordID']);
foreach ($BB as $rowB) 
{
  $countPendingBooking=(int)$rowB['totalPending'];
}


$user3=new rental();
$CA=$user3->countConfirmedRentalLandlord($_SESSION['landlordID']);
foreach ($CA as $rowC) {
  $countConfirmedRental=(int)$rowC['total'];
}

$user4=new rental();
$AllC=$user4->countAllRentalLandlord($_SESSION['landlordID']);
 ...
 <div class="w3-row-padding w3-margin-bottom">
  ...
  <div class="w3-quarter">
    <div class="w3-container w3-green w3-padding-16 shadow">
      ...
      <div class="w3-right">
        <h3 style="font-size:30px;"><?php echo $countPendingBooking; ?></h3>
      </div>
      <div class="w3-clear"></div>
