...
if (isset($_GET['QStrrentalID']))
  {
    ...
    $message = 'Hi User , The UDM Online Student Lodging Accomodation Management System (OSLAMS) Landlord has just updated (Payment) one of your rental.Kindly login account to verify';
  ...
  if (isset($_POST['btnSubmit']))
  {
   ...
   $cryptoPayment=$_POST['cryptoPayment'];
   $rental = new rental();
   $rental->updatePayment($_SESSION['rentalID'],$cryptoPayment);
...
<!-- START of Container to have Form for Tenant -->
  <div class="container">
    <div class="panel panel-info shadow">
       <div class="panel-heading"><h3><center>Update Crypto Payment Status</center></h3></div>
         <div class="panel-body">
           ...
           <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
               <label for="">Tenant Blockchain Address ID : </label>
            ...
            <button type="submit" id="submit-button" class="btn btn-info" name="btnSubmit">Update Payment</button>&nbsp;
