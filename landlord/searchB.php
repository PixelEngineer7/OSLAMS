...
$result = mysqli_query($conn,"SELECT * from tblproperty WHERE approved=1 AND status='Available' AND address like '%$search%'");
...
<style>
  ...
  h3,h5,p {font-size: 12px;, font-family: "Arial", sans-serif}
</style>
<style>
  .card{
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
  ...
  <div class="w3-bar-block">
    ...
    <a href="../applicant/applicantDashboard.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
      ...
      <div class="row">
        <?php while ($row = mysqli_fetch_array($result))   { ?>
          <div class="card">
            ...
            <div class="card-txt">
              <center><?php echo "<a  class='btn btn-success' href='propertyBookingsB.php?action=update&QStrpropertyID=".$row['propertyID']."'>Book Here</a>"; ?></center>
            </div>
            <div class="card-txt">
