...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
  ...
  <div class="w3-bar-block">
    ...
    <a href="contactus" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-envelope"></i>  Contact Us</a>
  </div>
</nav>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:33px">
     <h4></strong>&nbsp;<b><i class="fa fa-tachometer" aria-hidden="true"></i> | Contact Us</b></h4>
  </header>
