<?php
   ...
   //Scope: Landlord Dashboard / Payment System
session_start();
...
$rental=$viewrental->getAllRental($_SESSION['landlordID']);
?>
<!DOCTYPE html>
<html lang="en">
<title>UDM OSLAMS Landlord | Payment System Dashboard </title>
<meta charset="UTF-8">
...
<div class="w3-container">
  <div class="panel panel-warning shadow">
    <div class="panel-heading"><h4><center>Ɖogecoin Based Crypto Payment System</center></h4>
    </div>
    <div class="table-responsive">
     ...
     <table class="table table-hover" id="myTable">
      <tr>
        ...
        <th scope="col">Tenant Bsc Address</th>
    ...
    <?php while ($row = mysqli_fetch_array($resultRental))   { ?>
      <tbody>
        <tr>
          ...
          <td><?php echo $row['bscAddress']; ?></td>
          <td><?php echo $row['cryptoPayment']; ?></td>
          <td><?php echo "<a  class='btn btn-success' href='updatePayment.php?action=update&QStrrentalID=".$row['rentalID']."'>Update</a>"; ?></td>
  ...
  for ($i=1; $i<=$total_pages; $i++) {
    $pagLink .= "<li class='page-item'><a class='w3-hover-blue' href='paymentSystem.php?page=".$i."'>".$i."</a></li>"; 
  }
  echo $pagLink . "</ul>";  
  ?>
</div>
