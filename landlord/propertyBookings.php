...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Applicant | Property Booking</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
    ...
    <div class="w3-container">
      <center><img src="../images/studentpros.png" class="img-responsive" alt="Tenant Logo" style="width:80px;"></center>
      <br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="../applicant/viewBooking.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-calendar-plus-o"></i>  View Booking</a>
    <a href="../landlord/propertyOnRents.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-home"></i>  Property on Rent</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:73px">
     <h4></strong>&nbsp;<b><i class="fa fa-tachometer" aria-hidden="true"></i> | Prospect Student Dashboard</b></h4>
  </header>
  ...
  <div class="form">
      <div class="panel panel-success">
          <div class="panel-heading">
            <h1 class="text-center">Booking of Property</h1>
          </div>
        <div class="panel-body">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="date" id="start" name="bookingDate" value="2021-08-07" min="2021-01-01" max="2022-12-31" required>
            </div>

            <div class="form-group">
              <label for="">Start Date</label>
              <input  class="form-control" type="date" id="start" name="startDate" value="2021-10-04" min="2021-01-01" max="2022-12-31" required>
            </div>
             ...
             <div class="form-group">
              <label>Booking Status</label>&nbsp;&nbsp;
                 <div class="form-check form-check-inline">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="status" id="inlineRadio2" value="Approved" disabled>
                      <label class="form-check-label" for="inlineRadio2">Approved</label>
                   </div>  
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="status" id="inlineRadio2" value="Confirmed" disabled>
                      <label class="form-check-label" for="inlineRadio2">Confirmed</label>
                   </div> 
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="status" id="inlineRadio2" value="Cancelled" disabled>
