...
<?php
  ...
  //Scope: Landlord Dashboard / Booking Approval Where Users have applied for.
session_start();
...
$user=new user();
$usr=$user->retrieveUser($username);
?>
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Landlord | Welcome Landlord Dashbord </title>
<meta charset="UTF-8">
...
<body class="w3-light-grey">
  ...
  <div class="w3-bar-block">
    ...
    <a href="landlordDashboard.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-container">
  ...
  <center><h3 class="p-2 mb-2 bg-info text-white">Informations about Student Lodging</h3></center>
  ...
  <center><h3 class="p-2 mb-2 bg-success text-white">Informations about Student Lodging</h3></center>
  ...
  <center><h3 class="p-2 mb-2 bg-danger text-white">Warning</h3></center>
  ...
  <h4>If <strong><?php echo $usr[0]['name'];?> , <?php echo $usr[0]['surname'] ;?></strong> , You are not suppozed to be here, We suggest you to log out immediately and displose any logs to UDM Administrator on following email address : <strong style="color:red;">admin@udm.ac.mu</strong></h4>
  ...
  <center><h3 class="p-2 mb-2 bg-warning text-white">Crypto Currency Payment System</h3></center>
  <h4>This Online Student Logding Management System with help of Dogecoin has setup a crypto currency payment system.The users ( Landlord , Tenant) have to share their crypto wallet address for identification process.The system automatically converts Rupees(Rs) into Dogecoin(Ɖ) . </h4>
