...
<?php
  ...
  //Scope: Landlord Dashboard / Script to update the Booking Status
 session_start();
 ...
 require_once(__DIR__.'/../controller/user.php');
   ...
   if (isset($_GET['QStrbookingID']))
  {
    ...
    $message = 'Hi User , The UDM Online Student Lodging Accomodation Management System (OSLAMS) Landlord has just updated (STATUS) one of your booking.Kindly login account to verify';
  ...
  <div class="form">
      <div class="panel panel-success shadow">
          <div class="panel-heading">
            <h3 class="text-center">Property Booking Update Management</h3>
          </div>
        <div class="panel-body">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
             ...
             <?php echo $row[0]['duration']; ?> Months
            </div>
            ...
            <button type="submit" id="submit-button" class="btn btn-info" name="btnSubmit">Update Booking</button>&nbsp;
