<?php
    ...
    //Scope: Landlord Dashboard / View Landlord Details including Name and User Details
    session_start();
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Landlord | Landlord Dashbord </title>
<meta charset="UTF-8">
...
<div class="w3-bar w3-top w3-white w3-large" style="z-index:3">
   <button class="w3-bar-item w3-button w3-hide-large w3-hover-none w3-hover-text-blue" onclick="w3_open();"><i class="fa fa-bars"></i> Menu</button>
    <span class="w3-bar-item w3-right"><img src="../images/minLogo.png"   alt="" >&nbsp; &nbsp;<h3 style="display: inline-block"><b>Online Student Lodging Accomodation Management System</b></h3></span>
</div>
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
  ...
  <div class="w3-bar-block">
      ...
      <a href="viewlandlord.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-user-circle-o"></i>  User Details</a>
    ...
    <div class="form">
        <div class="panel panel-info">
          <div class="panel-heading">
             <h1 class="text-center">Landlord Profile Information</h1>
          </div>
        <div class="panel-body">
          <form >
               ...
               <?php } ?>
               <?php echo "<a  onclick='update()' class='btn btn-danger' href='changePassword.php?action=update&QStruserID=".$row['userID']."'>Change Password</a>"; ?>
            </form>
        </div>
      </div>
    </div>
 ...
 <div class="container">
    <div class="form">
        <div class="panel panel-success">
          <div class="panel-heading">
             <h1 class="text-center">Landlord Personal Information</h1>
          </div>
        <div class="panel-body">
          <form >
                <?php foreach($landlordview as $row) { ?>
                ...
                <div class="form-group">
                    <label for="">Home | Company Phone :</label>
                    <?php echo $row['phone']; ?>
                </div>
               ...
               <?php } ?>
                <?php echo "<a  onclick='update()' class='btn btn-info' href='updateProfile.php?action=update&QStruserID=".$row['userID']."'>Update Profile</a>"; ?>
            </form>
