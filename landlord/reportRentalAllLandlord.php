...
$database = new DBHandler();
$viewAll = new rental();
$view=$viewAll->getReportRentalAllLandlord($landlordID);
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="w3-container">
    <div class="panel panel-primary shadow">
      <div class="panel-heading"><h4><center>List of all Landlord Rental Made on the System </center></h4>
      </div>
    ...
    <button class="btn btn-info" onClick="window.print()">Print</button>&nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportAllLandlord.php';">Export</button>
  </div>
