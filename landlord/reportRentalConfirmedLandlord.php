...
$database = new DBHandler();
$viewAll = new rental();
$view=$viewAll->getReportRentalConfirmedLandlord($landlordID);
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="w3-container">
    <div class="panel panel-danger shadow">
      <div class="panel-heading"><h4><center>List of all Confirmed Rental Made on the System </center></h4>
      </div>
    ...
    <button class="btn btn-info" onClick="window.print()">Print</button>&nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportConfirmedRentalLandlord.php';">Export</button>
  </div>
