<?php
   ...
   //Scope: Student Dashboard / Creation of Booking
session_start();
...
if (isset($_POST['btnSubmit']))
{
  ...
  header('location:propertyOnRentsB.php');
  
}
?>
<!DOCTYPE html>
<html lang="en-US">
<title>UDM OSLAMS Student | Property Booking</title>
<meta charset="UTF-8">
    ...
    <div class="panel panel-success">
      ...
      <div class="panel-body">
        <form method="post" enctype="multipart/form-data">
          ...
          <a href="propertyOnRentsB.php" class="btn btn-warning">Cancel</a>   
        </form>
      </div>
