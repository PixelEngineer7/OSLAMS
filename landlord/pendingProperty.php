...
<?php
   ...
   //Scope: Landlord Dashboard / View Pending Property on OSLAMS by LandlordID.
session_start();
...
$result = mysqli_query($conn,"SELECT * FROM tblproperty WHERE approved=0 AND landlordID='$landlordID' ORDER BY propertyID ASC LIMIT $start_from, $limit");
...
<body class="w3-light-grey">
  ...
  <nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
    ...
    <div class="w3-container">
      <center><img src="../images/landlord.jpg" class="img-responsive" alt="" style="padding-top:10px;"></center>
      <br>
...
<div class="w3-container">
  <div class="panel panel-danger shadow">
    <div class="panel-heading"><h4><center>List of Pending Property Approval by UDM Administration</center></h4>
    </div>
    <div class="table-responsive">
      ...
      <table class="table table-hover" id="myTable">
        <tr>
          ...
          <th scope="col">Approval By UDM</th>
      ...
      <?php while ($row = mysqli_fetch_array($result))   { ?>
        ...
        echo "YES";
          ...
          echo "NO";
      ?></td>
      <td class="badge bg-info text-light">
        <?php if ((int)$row['approved']==1)
        echo "YES";
        else
          echo "NO"; ?></td>

        <td>  <?php echo "<a class='btn btn-success' href='viewProperty.php?action=update&QStrpropertyID=".$row['propertyID']."'>View</a>" ?> </td>
...
$result_db = mysqli_query($conn,"SELECT COUNT(propertyID) FROM tblproperty WHERE approved=0 AND landlordID='$landlordID'"); 
...
for ($i=1; $i<=$total_pages; $i++) {
  $pagLink .= "<li class='page-item'><a class='w3-button w3-hover-purple' href='pendingProperty.php?page=".$i."'>".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</div>
