<?php
  ...
  session_start();
    ...
    $propertyRent=$property->propertyOnRentA($database);

    
?>
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Student | Property On Rent </title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
  ...
  <div class="w3-bar-block">
    ...
    <a href="../landlord/propertyOnRentsB.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-home"></i>  Property on Rent</a>
  ...
  <div class="row">
    <div class="col">
     ...
     <div class="col">
        ...
        <b>Search Property on OSLAMS : </b><input type="text" name="search" placeholder=" Property Address" /><button type="submit"><i class="fa fa-search"></i></button>
              ...
              <div class="card">
                ...
                &nbsp;
                 <?php echo "<img src = 'images/" . $row['pictures'] ."' '>";?>
                  ...
                  <div class="card-txt">
                      <center><?php echo "<a  class='btn btn-success' href='propertyBookingsB.php?action=update&QStrpropertyID=".$row['propertyID']."'>Book</a>"; ?></center>
                  </div>
                  <div class="card-txt">
                    <center><?php echo "<a  class='btn btn-primary' href='moreDetailsB.php?action=update&QStrpropertyID=".$row['propertyID']."'>More Details..</a>"; ?></center>
                  </div>
                  &nbsp;
              </div>
