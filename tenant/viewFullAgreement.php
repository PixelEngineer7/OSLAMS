<?php
 ...
 //Scope: Tenant Dashboard | View Rental Agreement
    session_start();
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS | View Rental Agreement Dashboard </title>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:33px">
     <h4></strong>&nbsp;<b><i class="fa fa-tachometer" aria-hidden="true"></i> | View Rental Agreement</b></h4>
  </header>
