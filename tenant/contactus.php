...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Tenant | Contact Us </title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
  ...
  <div class="w3-container">
   ...
   <div class="w3-bar-block">
      ...
      <a href="contactus.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-envelope"></i>  Contact Us</a> 
  </div>
</nav>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:33px">
     <h4 style="font-size:20px;" ></strong>&nbsp;<b><i class="fa fa-tachometer" aria-hidden="true"></i> | Contact Us</b></h4>
  </header>
  ...
  <div class="panel">
      <div class="panel-heading">
       <div class="panel-body">
        <div class="col-md-4">
          <img src="../images/udmRH.jpg" class="card-img">
        </div>
            <span class="badge bg-primary"><h5>Rose Hill Campus</h5></span>
            <br><br>
            <p><b>Address : </b> Rose-Hill campus Avenue de la Concorde,Roches Brunes</p>
            <p>Telephone Number : 230-460-9500</p>
            <p>E-mail Address : campusRH@admin.udm.ac.mu</p>
       </div>
      </div>
  </div>
</div>
...
<div class="container">
  <div class="panel">
      <div class="panel-heading">
       <div class="panel-body">
        <div class="col-md-4">
          <img src="../images/udmPM.jpg" class="card-img">
        </div>
            <span class="badge bg-info"><h5>Swami Dayanand Campus</h5></span>
            <br><br>
            <p><b>Address : </b>Beau Plan Round About Pamplemousses </p>
            <p>Telephone Number : 230-260-4500</p>
            <p>E-mail Address : campusPM@admin.udm.ac.mu</p>
       </div>
      </div>
  </div>
</div>
...
<div class="container">
  <div class="panel">
      <div class="panel-heading">
       <div class="panel-body">
        <div class="col-md-4">
          <img src="../images/udmBA.jpg" class="card-img">
        </div>
             <span class="badge bg-warning"><h5>Bel Air Campus</h5></span>
             <br><br>
            <p><b>Address : </b>Bel Air campus (Ex-Mauritius Research Council) Corner Trou d’Eau Douce Branch Road, Royal Road,Bel Air</p>
            <p>Telephone Number  : 230-417-1234</p>
            <p>E-mail Address : campusBA@admin.udm.ac.mu</p>
       </div>
      </div>
  </div>
</div>
