...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Tenant | View Rental Agreement  Dashboard </title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-collapse w3-light w3-animate-left" style="z-index:4;width:300px;" id="mySidebar">
  ...
  <div class="w3-bar-block">
    ...
    <a href="tenantDashboard.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
...
<div class="w3-container">
  ...
  <br>
    ...
    <center><h3 class="p-3 mb-2 bg-info text-white">Informations about Student Lodging</h3></center>
    ...
    <center><h3 class="p-3 mb-2 bg-success text-white">Informations about Student Lodging</h3></center>
    ...
    <center><h3 class="p-3 mb-2 bg-danger text-white">Warning</h3></center>
