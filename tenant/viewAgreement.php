...
if (isset($_GET['QStrbookingID'],$_GET['QStrrentalID'],$_GET['QStrtenantID'],$_GET['QStrpropertyID']))
  ...
  if (isset($_POST['btnSubmit']))
  {
     ...
     $rental = new rental();
     $rental->agreeRental($_SESSION['rentalID'],$remarks,$bscAddress);
...
<div class="panel panel-info">
  ...
  <div class="panel-footer">Read And Approved By the Tenant
    <div class="form-group">
             ...
             <div class="form-group">
                  <label for="">Tenant BlockChain Address (ÐOGE) <i>Optional</i>:</label>
                  <input class="form-control" type="text" id="bscAddress" name="bscAddress">
                </div>
           <input type="submit" value="Accept" class="btn btn-info" name="btnSubmit" id="btnSubmit"/> &nbsp;
