<?php
 ...
 //Scope: Tenant Dashboard | View Profile
    session_start();
    ...
    <div class="form">
        <div class="panel panel-info shadow">
          <div class="panel-heading">
             ...
             <h3 style="font-size:20px;"class="text-center"><i class="fa fa-user-o" aria-hidden="true"></i>  Tenant Profile Information</h3>
          </div>
 ...
 <div class="w3-container">
    <div class="form">
        <div class="panel panel-success shadow">
          <div class="panel-heading">
             <h3 style="font-size:20px;" class="text-center"><i class="fa fa-info-circle" aria-hidden="true"></i>  Tenant Personal Information</h3>
          </div>
        <div class="panel-body">
          <form >
