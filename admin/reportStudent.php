<?php
 ...
 //Scope: Reports | List of all Cancelled Booking Made on the System
session_start();
 ...
 require '../controller/user.php';
    ...
    $database = new DBHandler();
    $viewAll = new user();
    $view=$viewAll->getDetail($database);
?>
<!DOCTYPE html>
<html lang="en">
...
<div class="w3-container">
      <div class="panel panel-danger shadow">
        <div class="panel-heading"><h4><center>List of all Prospect Student on the System </center></h4>
        </div>
    ...
    <?php foreach($view as $row) { ?>
      ...
      <?php } ?>
       ...
       <button class="btn btn-info" onClick="window.print()">Print</button> &nbsp;  <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportStudents.php';">Export</button>
  </div>
