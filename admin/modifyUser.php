...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
      <div class="panel panel-warning shadow">
        <div class="panel-heading"><h4><center>List of All Registered Users on the System</center></h4>
        </div>
     ...
     <?php while ($row = mysqli_fetch_array($result))   { ?>
      <tbody id="myTable">
        <tr>
          ...
          <td><?php echo "<a  class='btn btn-info' href='editUser.php?action=update&QStruserID=".$row['userID']."'>Modify </a></td>"; ?>
        </tr>
      </tbody>
      <?php } ?>
    </table>
          ...
          for ($i=1; $i<=$total_pages; $i++) {
                        $pagLink .= "<li class='page-item'><a class='w3-hover-indigo' href='modifyUser.php?page=".$i."'>".$i."</a></li>"; 
          }
          echo $pagLink . "</ul>";  
?>
          </div>
