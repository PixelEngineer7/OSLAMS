<?php
 ...
 //Scope: Reports | List of all Registered Tenant on the System
 session_start();
    ...
    $database = new DBHandler();
    $viewAll = new tenant();
    $view=$viewAll->getTenant($database);
...
<div class="w3-container">
      <div class="panel panel-success shadow">
        <div class="panel-heading"><h4 ><center>List of all Registered Tenant on the System </center></h4>
        </div>
    ...
    <?php foreach($view as $row) { ?>
      ...
      <?php } ?>
       ...
       <button class="btn btn-info" onClick="window.print()">Print</button>  &nbsp;  <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportTenants.php';">Export</button>
  </div>
 </div>
