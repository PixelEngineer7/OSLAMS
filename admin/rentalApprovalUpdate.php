...
if (isset($_POST['btnSubmit']))
{
 ...
 header('location:rentalApproval.php');
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <!-- Header -->
  <header class="w3-container" style="padding-top:23px">
...
<div class="container">
  <div class="panel panel-info shadow">
   <div class="panel-heading"><h3 style="font-size:20px;" ><center>Update Rental Status</center></h3></div>
   <div class="panel-body">
    <?php foreach($viewtenant as $row) { ?>
     <form method="post" enctype="multipart/form-data">
      ...
      <a href="rentalApproval.php" class="btn btn-warning">Cancel</a> 
