<?php
    ...
    //Scope: User Management Dashboard | Password Change
session_start();
    ...
    <div class="table-responsive">
     ...
     <div class="table-responsive">
        ...
        <?php while ($row = mysqli_fetch_array($result))   { ?>
          <tbody id="myTable">
            <tr>
              ...
              <td><?php echo "<a  class='btn btn-success' href='passwordEdit.php?action=update&QStruserID=".$row['userID']."'>Change </a></td>"; ?>
            </tr>
          </tbody>
        <?php } ?>
      </table>
      ...
      for ($i=1; $i<=$total_pages; $i++) {
        $pagLink .= "<li class='page-item'><a class='w3-hover-yellow' href='passwordChange.php?page=".$i."'>".$i."</a></li>"; 
      }
      echo $pagLink . "</ul>";  
      ?>
    </div>
