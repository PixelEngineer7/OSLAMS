<?php
 ...
 //Scope: Reports | List of all Registered Property on the System
session_start();
...
$view=$viewAll->getAllProperty($database);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    <div class="panel panel-secondary shadow">
      <div class="panel-heading"><h4><center>List of all Registered Property on the System </center></h4>
      </div>
    ...
    <button class="btn btn-info" onClick="window.print()">Print</button> &nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportRegisteredProperty.php';">Export</button>
  </div>
