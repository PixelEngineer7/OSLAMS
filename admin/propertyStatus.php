  ...
  <div class="panel panel-info shadow">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover" id="myTable">
        <thead >
          <tr>
            ...
            <th onclick="sortTable(0)" scope="col">Rating <i class="fa fa-sort-numeric-desc" aria-hidden="true"></i> </th>
        ...
        <?php while ($row = mysqli_fetch_array($result))   { ?>
          <tbody id="myTable">
            <tr>
              ...
              <td><?php echo "<a  class='btn btn-info' href='propertyStatusUpdate.php?action=update&QStrpropertyID=".$row['propertyID']."&QStrlandlordID=".$row['landlordID']."'>Update</a>"; ?></td>
            </tr>
      ...
      for ($i=1; $i<=$total_pages; $i++) {
        $pagLink .= "<li class='page-item'><a class='w3-hover-purple' href='propertyStatus.php?page=".$i."'>".$i."</a></li>"; 
      }
      echo $pagLink . "</ul>";  
      ?>
    </div>
