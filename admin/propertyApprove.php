...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="m-4">
  <div class="row row-cols-1 row-cols-md-3 g-4">
   ...
   <div class="col">
    <div class="card shadow">
      <center><img src="../images/rent.gif" class="img-responsive" alt="" style="padding-top:10px;"></i></center>
      <div class="card-body">
...
<div class="w3-container">
  <div class="panel panel-success shadow">
      ...
      <table class="table table-hover" id="myTable">
        <thead >
          <tr>
            ...
            <th onclick="sortTable(0)" scope="col"><i class="fa fa-sort"></i>Approval By UDM</th>
            <th scope="col">Approve Property</th>
          </tr>
        ...
        <?php while ($row = mysqli_fetch_array($result))   { ?>
         <tbody id="myTable">
          <tr>
            ...
            <td><?php if ((int)$row['approved']==1)
            echo "YES";
            else
              echo "NO"; ?></td>

            <td><?php echo "<a  class='btn btn-success' href='propertyUpdate.php?action=update&QStrpropertyID=".$row['propertyID']."'>Update</a>"; ?></td>
          </tr>
    ...
    for ($i=1; $i<=$total_pages; $i++) {
      $pagLink .= "<li class='page-item'><a class='w3-hover-red' href='propertyApprove.php?page=".$i."'>".$i."</a></li>"; 
    }
    echo $pagLink . "</ul>";  
    ?>
  </div>
