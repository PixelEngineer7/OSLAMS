<?php
    ...
    //Scope: Property Management Dashboard | Property Approval By UDM Administrator
...
if (isset($_POST['btnSubmit']))
{
 ...
 $prop=new property();
 $prop->approvedProperty($_SESSION['propertyID'],$approved);
 header('location:propertyApprove.php');
    ...
    <div class="form">
      <div class="panel panel-success shadow">
        <div class="panel-heading">
          ...
          <h1 style="font-size:20px;" class="text-center">Property Approval By UDM Administrator</h1>
        </div>
        ...
        <div class="panel-body">
          <form method="post" enctype="multipart/form-data">
            ...
            <label for="">Approve Property</label>
            <?php echo "<select name='approved' class='form-control' value='".$row[0]['approved']."'>";?>
          ...
          <div>
            ...
            <a href="propertyApprove.php" class="btn btn-warning">Cancel</a>   
          </form>
        </div>
      </div>
    </div>
