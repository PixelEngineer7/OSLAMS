<?php
 ...
 //Scope: Reports | List of all Confirmed Rental Made on the System
session_start();
...
$database = new DBHandler();
$viewAll = new rental();
$view=$viewAll->getReportRentalConfirmed($database);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <div class="w3-container">
    ...
    <button class="btn btn-info" onClick="window.print()">Print</button>&nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportConfirmedRental.php';">Export</button>
  </div>
