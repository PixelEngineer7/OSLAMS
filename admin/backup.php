<?php
  ...
  //Scope: Backup and Restore Database
session_start();
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <h3><center><u>Backup | Restore Database</u></center></h3>
  <div class="m-4">
    <div class="row row-cols-1 row-cols-md-3 g-4">
      <div class="col">
        <div class="card">
          <center><img src="../images/backup.png" class="img-responsive" alt="" style="padding-top:10px;"></center>
          <div class="card-body">
            <center><h5 class="card-title">Backup SQL Database system</h5></center>
            <center><p class="card-text">Generate a backup of the database</p></center>
          </div>
          <div class="card-footer">
            <center><button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/backupSQL.php';">Generate SQL Backup</button></center>
          </div>
        </div>
      </div>
      <div class="col">
        <div class="card">
         ...
         <div class="card-body">
           <center><h5 class="card-title">Restore SQL Database system</center>
            <center><p class="card-text">Restore database of the system</p></center>
          </div>
          <div class="card-footer">
           <center><button type="cancel" class="btn btn-info" onclick="javascript:window.location='restore.php';">Restore Database</button></center>
         </div>
       </div>
     </div>
   </div>
