...
if (isset($_GET['QStrtenantID'] ,$_GET['QStrpropertyID'] , $_GET['QStrrentalID'] ))
{
...
$database = new DBHandler();
$viewtenant = new user();
$viewt=$viewtenant->getUserInfo($_SESSION['userID']);
...
$viewb=$viewbooking->getBooking($_SESSION['propertyID']);
...
<!DOCTYPE html>
<html lang="en">
<title>UDM OSLAMS Administrator | Booking Management Dashboard </title><meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
 ...
 <div class="w3-container">
  <div class="panel panel-info shadow">
    <div class="panel-heading"><h3 style="font-size:20px;" ><center>Rental Agreement Between Landlord and Tenant</center></h3></div>
    <div class="panel-body">
      ...
      <div class="panel-footer">Read And Approved By the Tenant
        <div class="form-group">
          <label for="">Digital Signature</label><br>
          <em><?php echo $remarks ?></em>
        </div>
      </div>
