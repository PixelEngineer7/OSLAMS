<?php
 ...
 //Scope: Reports | List of all Registered Landlord on the System
...
$database = new DBHandler();
$viewAll = new landlord();
$view=$viewAll->getLandlord($database);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <h3 style="font-size:20px;"><center><u>List of User reports on UDM OSLAMS</u></center></h3>

  <div class="w3-container">
    <div class="panel panel-info shadow">
      <div class="panel-heading"><h4><center>List of all Registered Landlord on the System </center></h4>
      </div>
    ...
    <button class="btn btn-info" onClick="window.print()">Print</button> &nbsp;  <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportLandlords.php';">Export</button>
  </div>
