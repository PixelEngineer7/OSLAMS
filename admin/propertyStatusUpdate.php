<?php
    ...
    //Scope: Landlord Dashboard / Rental Agreement
...
if (isset($_GET['QStrpropertyID'],$_GET['QStrlandlordID']))
{
...
$email=$landlord->getDetailsLandlord( $_SESSION['landlordID']);

$to = $email[0]['email'];
$subject = 'UDM OSLAMS Notification';
$message = 'Hi User , The UDM Online Student Lodging Accomodation Management System (OSLAMS) administrator has just updated (STATUS) one of your property.Kindly login account to verify';
...
if (isset($_POST['btnSubmit']))
{
 $status=$_POST['status'];
 $prop=new property();
 $prop->propertyStatus($_SESSION['propertyID'],$status);
...
<!DOCTYPE html>
<html>
<title>UDM OSLAMS Administrator | Property Status Update</title>
<meta charset="UTF-8">
    ...
    <div class="form">
      <div class="panel panel-default shadow">
        <div class="panel-heading">
          ...
          <h2 style="font-size:20px;"  class="text-center">Property Status Update By UDM Administrator</h2>
        </div>
        <div class="panel-body">
          <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <?php echo $row[0]['rating']; ?>
            </div>

            <div class="form-group">
              <label for="">Property Current Status :</label> &nbsp;<span class="label label-success"> <?php echo $row[0]['status']; ?></span><br>
              <label for="">Change Property Status</label>
              <?php echo "<select name='status' class='form-control' value='".$row[0]['status']."'>";?>
...
<script>
  function update() {
    alert("UDM OSLAMS: Property Record Updated Successfully!");
  }
</script>
