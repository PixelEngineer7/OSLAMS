<?php
    ...
    //Scope: Booking Management Dashboard | Booking Approval
session_start();
...
$getview=$viewBooking->getAll($database);
  ...
  <div class="panel panel-success shadow">
    ...
    <div class="table-responsive">
      ...
      <table class="table table-hover" id="myTable">
        <thead>
          <tr>
            ...
            <th onclick="sortTable(0)" scope="col">Booking Status <i class="fa fa-sort"></i> </th>
      ...
      for ($i=1; $i<=$total_pages; $i++) {
        $pagLink .= "<li class='page-item'><a class='w3-button w3-hover-purple' href='bookingApproval.php?page=".$i."'>".$i."</a></li>"; 
      }
      echo $pagLink . "</ul>";  
      ?>
    </div>
