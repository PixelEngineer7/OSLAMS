<?php
    ...
    //Scope: User Management Dashboard | Modification of User on System
...
if (isset($_POST['btnSubmit']))
{
 ...
 $usr=new user();
 $usr->changePassword($userID,$password);
  ...
  <div class="form">
    <div class="panel panel-primary shadow">
      <div class="panel-heading">
        ...
        <h3 style="font-size:20px ;" class="text-center">Modification of User on System</h3>
      </div>
      ...
      <div class="panel-body">
        <form method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <?php echo "<input type='text' class='form-control' name='password'  required value='".$row[0]['password']."' >"; ?>
          </div>


          <button type="submit" id="submit-button" class="btn btn-primary" name="btnSubmit">Update Record</button>&nbsp;
          <a href="passwordChange.php" class="btn btn-warning">Cancel</a>   
        </form>
      </div>
    </div>
  </div>
