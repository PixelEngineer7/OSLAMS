<?php
 ...
 //Scope: Reports | List of all Registered Property Available on the System
session_start();
...
$database = new DBHandler();
$viewAll = new property();
$view=$viewAll->propertyOnRent($database);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <h3 style="font-size:20px;"><center><u>List of Property reports on UDM OSLAMS</u></center></h3>

  <div class="w3-container">
    <div class="panel panel-warning shadow">
      <div class="panel-heading"><h4><center>List of all Registered Property Available on the System </center></h4>
      </div>
        ...
        <table class="table table-hover">
          <thead>
            <tr>
              ...
              <th scope="col">Approved by UDM</th>
          ...
          <?php foreach($view as $row) { ?>
            <tbody>
              <tr>
                ...
                <td><?php echo $row['rating']; ?> <i class="fa fa-star" aria-hidden="true"></i> Star</td>
  ...
  <button class="btn btn-info" onClick="window.print()">Print</button>&nbsp; <button type="cancel" class="btn btn-success" onclick="javascript:window.location='../controller/exports/exportPropertyAvail.php';">Export</button>
</div>
