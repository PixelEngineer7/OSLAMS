<?php
  ...
  //SCOPE: Script for Password Change Student
session_start();
...
if (isset($_POST['btnSubmit']))
{
  ...
  $modifyuser = new user();
  $modifyuser->passwordChange($_SESSION['username'],$password);
  header('location:viewProfile.php');
}   
?>
<!DOCTYPE html>
<html lang="en">
<title>UDM OSLAMS Applicant | Prospect Student Details Dashboard </title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:33px">
   <h4></strong>&nbsp;<b><i class="fa fa-tachometer" aria-hidden="true"></i> | Applicant User Details</b></h4>
 </header>
  ...
  <div class="form">
    <div class="panel panel-info shadow">
      <div class="panel-heading">
       ...
       <h3 class="text-center"><i class="fa fa-user-o" aria-hidden="true"></i>  Update Applicant Profile Information</h3>
     </div>
     <div class="panel-body">
      <form method="post" enctype="multipart/form-data" >
        ...
        <div class="form-group">
          ...
          <?php echo "<input type='text' name='password' class='form-control' value='".$row['password']."'>";?> 
        </div>
      ...
      <button type="submit" id="submit-button" class="btn btn-primary" name="btnSubmit" onclick="update()">Update Password</button>&nbsp;
