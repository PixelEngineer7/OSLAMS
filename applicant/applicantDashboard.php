...
<!DOCTYPE html>
<html lang="en">
<title>UDM OSLAMS Applicant | Prospect Student Dashboard </title>
<meta charset="UTF-8">
...
<body class="w3-light-grey">
  ...
  <div class="w3-bar-block">
    ...
    <a href="applicantDashboard.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
